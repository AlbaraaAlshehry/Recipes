...
namespace Recipes.Controllers
{
    public class RecipesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,RecipeName,Ingrediients,Preparation,Descreption,Price,ImageFile,Status,CreatedDate,CategoryId,UserId")] Recipe recipe)
        {
