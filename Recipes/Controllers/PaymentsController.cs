...
namespace Recipes.Controllers
{
    public class PaymentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,CardNumber,Ccv,ExDate")] Payment payment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Id,CardNumber,Ccv,ExDate")] Payment payment)
        {
            if (id != payment.Id)
            {
                return NotFound();
